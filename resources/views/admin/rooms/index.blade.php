...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-headline">All Rooms</h2>
            <a href="{{ route('admin.rooms.create') }}" class="bg-primary text-white px-4 py-2 rounded-md hover:bg-green-800 transition">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Number</th>
                ...
                <tbody class="text-gray-700">
                    @forelse ($rooms as $room)
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">{{ $room->price_per_night }}</td>
                            <td class="py-3 px-4 flex items-center space-x-2">
                                <a href="{{ route('admin.rooms.edit', $room->id) }}" class="text-blue-500 hover:text-blue-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-6 text-gray-500">No rooms found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
