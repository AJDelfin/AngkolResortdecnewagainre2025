...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-headline">All Services</h2>
            <a href="{{ route('admin.services.create') }}" class="bg-primary text-white px-4 py-2 rounded-md hover:bg-green-800 transition">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                ...
                <tbody class="text-gray-700">
                    @forelse ($services as $service)
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4 flex items-center space-x-2">
                                <a href="{{ route('admin.services.edit', $service->id) }}" class="text-blue-500 hover:text-blue-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-6 text-gray-500">No services found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
