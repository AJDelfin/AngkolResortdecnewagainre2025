@php
    $showRoute = $isGuests ? route('admin.guests.show', $customer) : route('admin.customers.show', $customer);
...
<a href="{{ $showRoute }}" class="text-green-500 hover:text-green-700">
...
<form class="delete-form" action="{{ $deleteRoute }}" method="POST">
    @csrf
    @method('DELETE')
